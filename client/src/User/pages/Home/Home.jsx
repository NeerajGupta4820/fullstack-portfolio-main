        ...
        <main name="home" className="w-full flex lg:flex-row flex-col gap-[2rem] justify-between lg:p-0 md:p-[1rem] p-[4px] " >
            ...
            <div className={` flex-col lg:w-[39rem] w-full lg:items-start items-center justify-start pt-32 gap-[1.5rem] text-white  `} >
                ...
                <h1 className="md:text-[5.5rem] text-[60px] font-extrabold w-full leading-[1.1em] lg:text-start text-center text-white "  >
                    I'm <span className="text-orange " >Neeraj Gupta</span>
                </h1>
                ...
                <div className="flex lg:justify-start justify-center items-center w-full gap-2 my-6 " >
                    <Link to='contact' className={`font-['PoppinsRegular'] bg-orange text-black cursor-pointer shadow-lg font-semibold rounded-[40px] px-[1.5rem] tracking-[1.2] py-[1rem] w-fit h-fit shadow-[0_4px_6px_rgba(255,255,255,0.8)]`}>
                        Contact Me
                    </Link>
                    <Link to='projects' className={`font-['PoppinsRegular'] bg-black text-white cursor-pointer border-white border-[0.2px]  shadow-lg font-normal rounded-[40px] px-[1.5rem] tracking-[1.2] py-[1rem] w-fit h-fit shadow-[0_4px_6px_rgba(255,255,255,0.5)]`}>
                        My Work
                    </Link>
                </div>
            </div>
